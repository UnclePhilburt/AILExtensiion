// Shared time-zone helpers. IMPACT shows and applies times in its own time
// zone (lead.impactTimeZone from the extension, default Eastern); the phone
// shows times in the rep's own zone.
