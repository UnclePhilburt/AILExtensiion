...
test('lead history preserves repeated calls and appointments, while comments are captured separately', () => {
  ...
  assert.deepEqual(Array.from(context.collectLeadComments({ querySelectorAll: () => [
    { textContent: 'Show More... Comment9/24/2026 7:56:31 PM IMV' }
  ] })), ['Comment · 9/24/2026 7:56:31 PM IMV']);
